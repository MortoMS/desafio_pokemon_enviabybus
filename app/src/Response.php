...
class Response
{
    ...
    {
        $this->base = System::getEnv('APP_URL');
    }
    ...
    public function run()
    {
        if (!$this->render) {
            ...
            if ($this->view !== null and file_exists($this->view)) {
                function run($view, $data, $json, $base, $renderComponent)
                {
                    ob_start();
                ...
                run($this->view, $this->data, $this->json, $this->base, function (...$data) {
